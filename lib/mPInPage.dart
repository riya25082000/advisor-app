...
class PassCodeScreen extends StatefulWidget {
  ...
  PassCodeScreen({Key key, @required this.currentAdvisorID}) : super(key: key);

  @override
  _PassCodeScreenState createState() => new _PassCodeScreenState(currentAdvisorID: currentAdvisorID);
}

class _PassCodeScreenState extends State<PassCodeScreen> {
  SharedPreferences preferences;
  String currentAdvisorID;
  _PassCodeScreenState({@required this.currentAdvisorID});
  ...
  var  enabled;
  Future getPin() async {
    var url = 'http://sanjayagarwal.in/Finance App/mpinAdvisorDetail.php';
  ...
  Future getTouchID() async {
    var url = 'http://sanjayagarwal.in/Finance App/TouchIDDetail1.php';
  ...
  Widget build(BuildContext context) {
    ...
    return LockScreen(
        title: "Security Pin ",
        passLength: 4,
        bgImage: "assets/images/app.jpg",
        fingerPrintImage: "assets/images/google.jpg",
        showFingerPass: true,
