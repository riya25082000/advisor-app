...
class ChangeMpin extends StatefulWidget {
  ...
  ChangeMpin({@required this.currentAdvisorID});
  @override
  _ChangeMpinState createState() =>
      _ChangeMpinState(currentAdvisorID: currentAdvisorID);
}

class _ChangeMpinState extends State<ChangeMpin> {
  String currentAdvisorID;
  _ChangeMpinState({@required this.currentAdvisorID});
  ...
  Future CheckPassword() async {
    oldpass = old.text;
    var url =
        'http://sanjayagarwal.in/Finance App/UserApp/SignIn and SignUp/checkoldpinadvisor.php';
  ...
  Future PasswordUpdate() async {
    ...
    print("********************************************************");
    var url =
        'http://sanjayagarwal.in/Finance App/UserApp/SignIn and SignUp/changepinadvisor.php';
